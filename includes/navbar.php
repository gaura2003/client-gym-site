...
<body class="bg-gray-100">
                    ...
                    <div class="ml-10 flex items-baseline space-x-4">
                        <?php if ($role === 'admin'): ?>
                            ...
                            <a href="/gym/admin/members.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Members</a>
                            ...
                            <a href="/gym/admin/manage_gym.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Gyms</a>
                            <a href="/gym/admin/reviews.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Reviews</a>
                            <a href="/gym/admin/membership_plans.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Plans</a>
                        ...
                        <?php elseif ($role === 'member' && isset($_SESSION['user_id'])): ?>
                            ...
                            <a href="/gym/schedule-history.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Schedule
                                History</a>
                            ...
                            <a href="/gym/payment_history.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Payment
                                History</a>
                        ...
                        <?php elseif (isset($_SESSION['owner_id'])): ?>
                            ...
                            <a href="../gym/manage_equipment.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Equipment</a>
                            <a href="../gym/bookings.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Schedules</a>
                            <a href="../gym/member_list.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Members</a>
                            <a href="../gym/earning-history.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Earn
                                History</a>
                        <?php else: ?>
                            <a href="/gym/"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Home</a>
                            <a href="/gym/view_membership.php"
                                class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Membership
                                Plans</a>
    ...
    <a href="/gym/includes/logout.php"
        class="text-red-500 hover:text-red-400 px-3 py-2 rounded-md text-sm font-medium">Logout</a>

    <?php
    // Notification link based on user type
    if (isset($_SESSION['owner_id'])) {
        echo '<a href="/gym/gym/notifications.php" class="relative text-white hover:text-gray-300">';
    } elseif (isset($_SESSION['user_id'])) {
        echo '<a href="/gym/notifications.php" class="relative text-white hover:text-gray-300">';
    }
    ?>
