    ...
    <?php if ($memberships): ?>
        ...
        <?php foreach ($memberships as $membership): ?>
            <div class="bg-white rounded-lg shadow p-6 mb-8">
                <h3 class="text-xl font-bold mb-4"><?php echo htmlspecialchars($membership['plan_name']); ?> Plan</h3>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <p class="text-gray-600">Valid until: <?php echo date('F j, Y', strtotime($membership['end_date'])); ?>
                        </p>
                        <p class="text-gray-600">Status: <?php echo ucfirst($membership['status']); ?></p>
                        <p class="text-gray-600">Price: ₹<?php echo number_format($membership['price'], 2); ?></p>
                    </div>
                    <div>
